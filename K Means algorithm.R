...
Total_C_classified = 133
Total_I_Classified = 17
Accuracy = (Total_C_classified/(Total_C_classified+Total_I_Classified))*100
#How did the model do?
#TASK: Accuracy = number of correctly classified/(total classified) = 0.88667
#i.e our model has achieved 88.667% accuracy!
